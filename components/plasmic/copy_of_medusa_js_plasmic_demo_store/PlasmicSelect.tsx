...
import Select__Overlay from "../../Select__Overlay"; // plasmic-import: fd7zG92l34Fh/component
import Select__Option from "../../Select__Option"; // plasmic-import: -F5WJ9K1WqnR/component
import Select__OptionGroup from "../../Select__OptionGroup"; // plasmic-import: pXJXuQqqgiuc/component
...
import sty from "./PlasmicSelect.module.css"; // plasmic-import: ijCUasFAP7e3/css

import ChevronDownIcon from "./icons/PlasmicIcon__ChevronDown"; // plasmic-import: IM9-oJml2nES/icon
import ChevronUpSvgIcon from "./icons/PlasmicIcon__ChevronUpSvg"; // plasmic-import: ORJtgvxGKUN-/icon
    ...
    if (!("children" in props)) {
      props = {
        ...
        children: (
          <React.Fragment>
            <Select__Option
              className={classNames("__wab_instance", sty.option__cCSpk)}
              value={"value1"}
            >
              {"Option 1"}
            </Select__Option>
            <Select__Option
              className={classNames("__wab_instance", sty.option__jktKh)}
              value={"value2"}
            >
              {"Option 2"}
            </Select__Option>
