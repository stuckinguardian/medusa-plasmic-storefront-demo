...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: 4mdOcJ3pjiMV/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvgIcon
              className={classNames(projectcss.all, sty.svg___2Xc9S)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg__ewZ0M)}
              role={"img"}
            />
          ),
