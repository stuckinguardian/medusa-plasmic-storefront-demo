...
import sty from "./PlasmicCopyrightSocialLanguage.module.css"; // plasmic-import: GDV6gty1k7A8/css

import TwitterIcon from "./icons/PlasmicIcon__Twitter"; // plasmic-import: rk4-KBow_IRt/icon
import MenuIcon from "./icons/PlasmicIcon__Menu"; // plasmic-import: tLfoPFexMQ-Z/icon
import YoutubeIcon from "./icons/PlasmicIcon__Youtube"; // plasmic-import: al1NxRs-yvyG/icon
import PintrestIcon from "./icons/PlasmicIcon__Pintrest"; // plasmic-import: 2Gq_ti3PNXXP/icon
import Icon15Icon from "./icons/PlasmicIcon__Icon15"; // plasmic-import: E_uwlJPHXgxX/icon
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__iyQv2)}
      >
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox___1F4U5)}
        >
          <div
          ...
          <div className={classNames(projectcss.all, sty.freeBox__cHx1I)}>
            <Button
              iconOnly={true}
              link={"http://twitter.com"}
              startIcon={
                <TwitterIcon
                  className={classNames(projectcss.all, sty.svg__dRzD2)}
                  role={"img"}
                />
              }
              submitsForm={true}
            ...
            <Button
              className={classNames("__wab_instance", sty.button__trVu2)}
              iconOnly={true}
              link={"http://youtube.com"}
              startIcon={
                <YoutubeIcon
                  className={classNames(projectcss.all, sty.svg__dYDcY)}
                  role={"img"}
                />
              }
              submitsForm={true}
            ...
            <Button
              className={classNames("__wab_instance", sty.button__yvFf)}
              iconOnly={true}
              link={"http://pinterest.com"}
              startIcon={
                <PintrestIcon
                  className={classNames(projectcss.all, sty.svg__e4Cco)}
                  role={"img"}
                />
              }
              submitsForm={true}
        ...
        <Button
          className={classNames("__wab_instance", sty.button__rj3Ew)}
          endIcon={
            <Icon15Icon
              className={classNames(projectcss.all, sty.svg__ceBdr)}
              role={"img"}
            />
          }
          showEndIcon={true}
          startIcon={
            <Icon15Icon
              className={classNames(projectcss.all, sty.svg__poJ)}
              role={"img"}
            />
          }
          submitsForm={true}
