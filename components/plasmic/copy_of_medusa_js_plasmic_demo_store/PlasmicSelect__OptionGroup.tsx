...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: pXJXuQqqgiuc/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: ijCUasFAP7e3/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__fTTd0)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__vjVL)}
              />
            </React.Fragment>
          ),
          value: args.children
